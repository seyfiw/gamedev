...
class Camera:
    ...
    def update(self):
        ...
        self.game_map.background.pos = (
            self.game_map.background.pos[0] + (camera_offset_x - self.game_map.background.pos[0]) * 0.1,
            self.game_map.background.pos[1] + (camera_offset_y - self.game_map.background.pos[1]) * 0.1
        )